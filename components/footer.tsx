...
export default function SmallCentered() {
  return (
    <Box pos="absolute" bottom={0} w="full" bg={useColorModeValue("gray.50", "blackAlpha.900")} color={useColorModeValue("gray.700", "gray.200")} borderTopWidth={1} borderStyle={"solid"} borderColor={useColorModeValue("gray.200", "whiteAlpha.200")}>
